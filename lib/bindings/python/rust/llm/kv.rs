...
impl KvEventPublisher {
    ...
    pub(crate) fn from_arc(
        ...
        Self {
            ...
            // Unified-backend bridge only. TRT-LLM multimodal execution stays on
            // the non-unified path (see components/src/dynamo/common/backend
            // README + trtllm/llm_engine.py), whose direct `KvEventPublisher`
            // constructor sets the marker; thread it here when MM moves to the
            // unified path.
            image_token_id: None,
        }
    }
